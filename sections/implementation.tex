...
% TODO: smooth transition to this section
...
Having a unique way to decompose trees, the next step is to outline how editor
expressions on well-formed trees can be implemented. Editor expressions are fundamental to
enabling interaction within the editor, providing the means to manipulate
a program through various operations. These include cursor movement, substitution
and conditional expressions.

\subsubsection{Cursor movement}
The general form of reduction rule for substitution is given in \cref{fig:red-rules-movement}
...
. These expressions evaluate conditions and execute corresponding editor actions
